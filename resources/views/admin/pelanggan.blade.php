...
<component id="controller">
    <div class="card">
        <div class="card-header">
            <a href="#" @click="tambahData()" class='btn btn-sm btn-primary pull-right'>Tambah Pelanggan</a>
        </div>
        <div class="card-body">
      ...
      <div class="modal-content">
       <form :action="actionUrl" method="post" autocomplete="off" @submit="submitForm($event, data.id)">
        ...
        <div class="modal-header">
            <h4 class="modal-title" v-if="!editStatus">Tambah Pelanggan</h4>
            <h4 class="modal-title" v-if="editStatus">Edit Pelanggan</h4>
